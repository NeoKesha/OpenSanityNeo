...
EXTERN SYSCALL ?foo@@YGXXZ : PROC
EXTERN SYSCALL ?PrintVector4@@YGXXZ : PROC
EXTERN SYSCALL ?PrintMatrix4@@YGXXZ : PROC
...
EXTERN SYSCALL ?EnableCalllog@@YGXXZ : PROC
EXTERN SYSCALL ?DisableCalllog@@YGXXZ : PROC
